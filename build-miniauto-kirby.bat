...
ant -f C:/Users/A.Petersell/Dropbox/DITA-SRCME/seminarwork-miniauto/build-petersell.xml -Dpubname=miniauto-kirby -logger org.dita.dost.log.DITAOTBuildLogger %1